...
ItemAnim::ItemAnim(int x, int y, ItemType itemType, bool fixed, bool collectable, bool mirrored, int16_t msgIndex):
    Item( x,  y, Item::ItemType::None,  fixed,  collectable,  mirrored,  msgIndex) {
